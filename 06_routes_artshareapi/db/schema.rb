...
ActiveRecord::Schema.define(version: 2022_01_12_154132) do
  ...
  create_table "likes", force: :cascade do |t|
    ...
    t.index ["user_id", "comment_id", "artwork_id"], name: "index_likes_on_user_id_and_comment_id_and_artwork_id", unique: true
